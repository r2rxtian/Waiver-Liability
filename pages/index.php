...
if($page==='reports'||$page==='templates')redirect('index.php?page=dashboard');
...
$titles=['dashboard'=>'Dashboard','new-waiver'=>'New waiver','waivers'=>'Waivers','approvals'=>'Pending acknowledgments','approval-sign'=>'Supervisor acknowledgment','waiver-view'=>'Waiver record','users'=>'Users','audit'=>'Activity logs','settings'=>'Settings'];page_start($titles[$page]??'Waivers',$page);
