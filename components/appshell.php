...
<main><header class="topbar"><button class="menu" aria-label="Open menu">☰</button><div class="topbar-brand"><span class="brand-mark">W</span><div><strong>Waiver Desk</strong><small>Waiver Management</small></div></div><div class="topbar-title"><span class="eyebrow">Waiver management</span><h1><?=e($title)?></h1></div><div class="top-user"><span><?=e(date('M j, Y'))?></span><span><?=e(date('g:i A'))?></span><span class="avatar small"><?=e(strtoupper(substr($u['full_name'],0,1)))?></span></div></header><div id="content" class="content">
